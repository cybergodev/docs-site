...
description: "Краткий справочник API CyberGo DD: создание логгеров, уровни, структурированные поля, ротация и буферизация, фильтрация, хуки, аудит и подписи целостности."
sidebar_position: 2
---
