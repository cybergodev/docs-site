...
title: "Интерфейсы - CyberGo DD | Иерархия Logger"
description: "Полная документация иерархии интерфейсов CyberGo DD: CoreLogger, LevelLogger, ConfigurableLogger и LogProvider для абстракции и внедрения зависимостей."
sidebar_position: 5
---
