...
- [Пакетные функции](../core/functions) -- функции обработки ошибок
- [Фильтрация безопасности](../security-audit/security) -- валидация безопасности путей
- [Система хуков](../security-audit/hooks) -- хук OnError
