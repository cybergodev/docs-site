...
description: "Руководство по HMAC-SHA256 подписям целостности логов CyberGo DD: IntegritySigner, подпись и проверка, серийные номера и обнаружение подделки."
sidebar_position: 3
---
...
После включения серийных номеров можно обнаружить удаление или перестановку логов. Если серийные номера не непрерывны, логи возможно были подделаны.
:::
