---
title: Обработка ошибок - CyberGo DD | Управление ошибками логирования
description: Полное руководство по обработке ошибок библиотеки логирования CyberGo DD, подробно объясняющее структурированные типы ошибок и иерархию, дизайн кодов ошибок, определения и методы оценки сторожевых ошибок, обёртку и развёртку ошибок через errors.Is/As, реализацию пользовательских стратегий обработки ошибок, механизмы восстановления после ошибок и конфигурацию обратных вызовов хуков ошибок, помогающее разработчикам точно идентифицировать и обрабатывать различные ошибки, связанные с логированием.
---
...
- [Константы и ошибки](../api-reference/constants) -- полный список кодов ошибок
- [Система хуков](../api-reference/hooks) -- HookRegistry
- [Фильтрация безопасности](../api-reference/security) -- ошибки, связанные с безопасностью
