...
description: "Полное руководство по обработке ошибок CyberGo DD: иерархия типов, сторожевые ошибки, обёртка через errors.Is/As, хуки и стратегии восстановления."
sidebar_position: 2
---
