...
description: "Контрольный список развёртывания CyberGo DD в продакшене: конфигурация, фильтрация данных, аудит, ротация файлов, HMAC-подписи и тесты производительности."
sidebar_position: 3
---
