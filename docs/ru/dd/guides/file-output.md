---
title: Вывод в файл и ротация - CyberGo DD | Руководство по конфигурации файловых логов
...
logs/app-001.log       ← Первая ротация
logs/app-002.log.gz    ← Сжатая старая резервная копия (при включении Compress)
```
