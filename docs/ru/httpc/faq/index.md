...
description: "FAQ по HTTPC: функции пакета против клиента, сравнение пресетов, прокси и DoH, сессии Cookie, настройка повторов и шаблоны сопоставления ошибок errors.Is/As."
sidebar_position: 1
---
