...
description: "Шпаргалка HTTPC предоставляет Go-разработчикам быстрый справочник по созданию и закрытию клиента, вызову семи HTTP-методов, всем двадцати шести функциям параметров запроса, обработке ответов Result и определению статуса, сравнению пяти предустановок конфигурации, настройке цепочек промежуточного ПО, определению типов ошибок и API загрузки файлов"
---
...
result.String()                        // читаемое представление (сенситивные заголовки замаскированы)
