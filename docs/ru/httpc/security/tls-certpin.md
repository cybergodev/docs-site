...
description: "Руководство по TLS и закреплению сертификатов HTTPC: управление версиями TLS 1.2-1.3 и шифрские наборы, загрузка пользовательских CA-сертификатов, двусторонняя аутентификация mTLS, API закрепления сертификатов CertificatePinner (SPKI-хэш/публичный ключ/цепочка), пользовательская проверка VerifyPeerCertificate и согласование HTTP/2."
---
