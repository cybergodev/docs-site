---
title: Базовые примеры - HTML
description: Коллекция базовых примеров использования библиотеки CyberGo HTML, демонстрирующая базовое извлечение контента, извлечение из файлов, извлечение только текста, вывод в формате Markdown, извлечение и группировку ссылок, повторное использование экземпляра Processor, извлечение с тайм-аутом через контекст, параллельную пакетную обработку и сериализацию в JSON, все примеры можно скопировать и запустить напрямую.
---
