...
description: Коллекция продвинутых примеров библиотеки CyberGo HTML, демонстрирующая реализацию пользовательского скорера Scorer, построение конвейера аудита с несколькими Sink, пакетную обработку файлов с управлением параллелизмом, паттерн пула Processor и мониторинг в реальном времени через ChannelAuditSink с полными работоспособными примерами кода.
---
