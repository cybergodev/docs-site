---
title: Система аудита на практике - HTML
description: Практическое руководство по системе аудита CyberGo HTML, от базового включения до построения многоуровневого конвейера аудита, включая подробное описание типов событий аудита, сравнение встроенных Sink, фильтрацию по уровням через LevelFilteredSink, реализацию пользовательских Sink, фильтрацию событий через FilteredSink и лучшие практики мониторинга аудита в производственной среде.
---
...
| Обход пути | `path_traversal` | critical | Путь к файлу содержит `..` |
...
Асинхронная отправка в канал, подходит для интеграции с внешними системами:
...
- [Справочник API: Система аудита](../api-reference/audit) - Полные сигнатуры API
