---
sidebar_label: "Выбор формата вывода"
title: "Выбор формата вывода - CyberGo html | сравнение форматов"
description: "Выбор формата вывода CyberGo html: сравнение текста, Markdown и JSON — особенности, сценарии и параметры конфигурации форматов."
sidebar_position: 2
---
...
- [Справочник API: Форматы вывода](../../api-reference/modules/output) - Полные сигнатуры API
- [Извлечение и группировка ссылок](./link-extraction) - Извлечение ссылок на ресурсы страницы
- [Подробная конфигурация](../../api-reference/core/config) - Все параметры конфигурации
