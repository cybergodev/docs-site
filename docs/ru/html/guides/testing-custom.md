...
description: Руководство по тестированию и пользовательским расширениям CyberGo HTML, включая реализацию пользовательского скорера Scorer, обход интерфейса ContentNode, настройку режима тестирования, подготовку mock-данных HTML и mock интерфейса Extractor, а также полные работоспособные примеры кода для распространённых сценариев расширения, помогает построить надёжную систему тестирования и возможности расширения.
---
