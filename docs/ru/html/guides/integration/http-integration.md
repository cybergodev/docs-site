...
- [Кэширование и повторное использование](../advanced-patterns/processor-cache) - Управление жизненным циклом Processor
- [Система аудита на практике](../advanced-patterns/audit-pipeline) - Мониторинг безопасности в производственной среде
- [Справочник API: Пакетная обработка](../../api-reference/modules/batch) - Полный API пакетной обработки
