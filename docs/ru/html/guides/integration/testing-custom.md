...
- [Справочник API: Интерфейсы](../../api-reference/types/interfaces) - Полные определения Scorer и ContentNode
- [Справочник API: Конфигурация](../../api-reference/core/config) - Поле конфигурации Scorer
