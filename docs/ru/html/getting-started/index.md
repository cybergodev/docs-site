...
- [Извлечение контента на практике](../guides/core-features/content-extraction) - Глубокое понимание процесса извлечения и распознавания статей
- [Выбор формата вывода](../guides/core-features/output-formats) - Выбор подходящего формата для вашего сценария
- [Повторное использование Processor и кэш](../guides/advanced-patterns/processor-cache) - Оптимизация производительности при высокочастотных вызовах
