...
Подробное использование и примеры в [Форматы вывода](../modules/output).
...
Подробное использование и примеры в [Извлечение ссылок](../modules/links).
...
Подробное использование и примеры в [Пакетная обработка](../modules/batch).
