...
description: Подробное описание Config библиотеки CyberGo HTML, включая управление ресурсами (MaxInputSize, кэш, тайм-аут), безопасность (очистка, ограничение глубины, аудит), извлечение контента (распознавание статей, сохранение медиа), форматы вывода (изображения, ссылки, таблицы), фильтрацию ссылок (Include*, ResolveRelativeURLs) и метод Validate для проверки.
---
