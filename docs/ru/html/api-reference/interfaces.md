...
description: Справочник API определений ключевых интерфейсов библиотеки CyberGo HTML, включая Extractor (полный интерфейс извлечения), StatsProvider (управление статистикой и кэшем), ContentNode (абстракция HTML-узла), Scorer (пользовательская стратегия скоринга) и AuditSink (вывод аудита), для расширения функциональности и интеграционного тестирования, помогает глубоко понять архитектуру библиотеки и механизмы расширения.
---
