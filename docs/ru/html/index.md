---
sidebar_label: "Обзор"
title: "HTML библиотека - CyberGo HTML | извлечение и очистка"
description: "CyberGo HTML — быстрая Go-библиотека извлечения и очистки HTML: распознавание статей, кодировки, пакетная обработка, аудит и вывод в текст, Markdown, JSON."
---
...
| Основа | [Извлечение контента](./guides/core-features/content-extraction) | Семейство Extract, конфигурация Config, интерпретация Result |
| Формат | [Форматы вывода](./guides/core-features/output-formats) | Вывод в Markdown / JSON, пользовательские шаблоны |
| Производительность | [Кэширование и повторное использование](./guides/advanced-patterns/processor-cache) | Жизненный цикл Processor, настройка кэша, пакетная обработка |
| Расширение | [Извлечение ссылок](./guides/core-features/link-extraction) | Извлечение ссылок, группировка, обнаружение ресурсов |
| Безопасность | [Конвейер аудита](./guides/advanced-patterns/audit-pipeline) | Система аудита, пользовательские Sink, мониторинг безопасности |
| Продвинутый | [Тестирование и расширения](./guides/integration/testing-custom) | Пользовательский Scorer, ContentNode, режим тестирования |
| Справочник | [Шпаргалка](./getting-started/cheatsheet) | Обзор часто используемых API |

## Следующие шаги

- [Быстрый старт](./getting-started/) - Руководство для начинающих за 5 минут
- [Шпаргалка](./getting-started/cheatsheet) - Краткий справочник часто используемых операций
