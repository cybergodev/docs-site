...
description: "CyberGo HTML — Go-библиотека извлечения и очистки HTML: распознавание статей, 15+ кодировок, ссылки, пакетная обработка, аудит, вывод в текст, Markdown, JSON."
---
