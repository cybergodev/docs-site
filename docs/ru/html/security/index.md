---
title: Обзор безопасности - HTML
description: Обзор средств безопасности библиотеки CyberGo HTML, включая ограничение размера ввода (по умолчанию 50 МБ), ограничение глубины DOM (по умолчанию 500), защиту от обхода пути, механизм восстановления после паники, управление тайм-аутами обработки, функцию очистки контента и подключаемую систему аудита, все нарушения безопасности поддерживают определение ошибок через errors.Is и errors.As, обеспечивая безопасную работу в производственной среде.
---
...
Подробная конфигурация безопасности аудита описана в [Система аудита](../api-reference/audit).
