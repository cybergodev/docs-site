---
title: Быстрый старт - HTML
description: Руководство по быстрому старту с библиотекой CyberGo HTML — за 5 минут освойте установку, базовое извлечение контента, четыре предустановки Config (по умолчанию, только текст, Markdown, высокая безопасность), три формата вывода (простой текст, Markdown, JSON), управление тайм-аутами контекста и потокобезопасные паттерны использования.
---
