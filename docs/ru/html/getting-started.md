...
description: "Быстрый старт с CyberGo HTML за 5 минут: установка, извлечение, пресеты Config, форматы вывода (текст, Markdown, JSON), тайм-ауты и потокобезопасность."
---
