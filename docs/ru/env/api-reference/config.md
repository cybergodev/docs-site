...
description: Справочная документация по API структуры Config библиотеки CyberGo env, включая пути поиска файлов, параметры безопасности, параметры валидации ключей и значений, настройки подстановки переменных, конфигурацию аудиторского лога и предопределённые шаблоны конфигурации с предустановками Development и Production для различных сред.
---
