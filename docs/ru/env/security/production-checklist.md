---
title: Контрольный список для продакшена - CyberGo env | Проверка безопасности перед развёртыванием
description: Контрольный список проверки безопасности перед развёртыванием в производственной среде библиотеки CyberGo env — права доступа к файлам .env и защита каталогов, валидация ключей RequiredKeys и AllowedKeys, включение аудитного журнала AuditEnabled, безопасная обработка чувствительных данных SecureValue, стратегии обработки сторожевых ошибок и настройка параметров безопасности и производительности LimitsConfig.
---
