...
description: "Маппинг CyberGo env: теги env, envDefault, envSeparator, envPrefix, вложенные структуры, указатели, срезы, конвертеры, дефолты и обязательная валидация."
sidebar_position: 1
---
