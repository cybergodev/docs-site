...
description: Полный справочник поддерживаемых конфигурационных форматов файлов библиотеки CyberGo env — синтаксис и комментарии форматов .env, JSON и YAML, поддержка типов данных, обработка кодировки UTF-8, механизм автоматического определения формата DetectFormat, специализированные параметры JSONConfig и YAMLConfig.
---
...
# Одинарные кавычки: буквальное сохранение, без экранирования
...
```bash
# Перевод строки в двойных кавычках
