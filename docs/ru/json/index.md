...
| [Синтаксис путей](./getting-started/path-syntax) | Запросы по пути, срезы, подстановочные знаки, извлечение полей |
...
| [Продвинутые примеры](./examples/examples-advanced) | Пакетное кодирование, предпарсинг, система хуков |
...
- [Синтаксис путей](./getting-started/path-syntax) — полное описание синтаксиса путей
