...
- [Определения интерфейсов](../api-reference/interfaces) - Интерфейсы CustomEncoder и TypeEncoder
- [Параметры конфигурации](../api-reference/config) - Поля Config, связанные с кодированием
