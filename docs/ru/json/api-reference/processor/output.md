...
Сигнатура: `func (p *Processor) Encode(value any, cfg ...Config) (string, error)`
...
Сигнатура: `func (p *Processor) EncodePretty(value any, cfg ...Config) (string, error)`
...
### Print (приватизировано)

::: warning Изменение API
`Print`, `PrintE`, `PrintPretty`, `PrintPrettyE` преобразованы во внутренние методы (нижний регистр) и больше не экспортируются как публичный API. Используйте следующие альтернативы:
