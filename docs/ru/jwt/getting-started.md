---
title: Быстрый старт - JWT
description: "Руководство по быстрому старту CyberGo JWT: установка и настройка, выпуск и проверка токенов, обновление и отзыв, выбор алгоритмов HMAC/RSA/ECDSA, пользовательские Claims, чёрный список и ограничение скорости."
---
