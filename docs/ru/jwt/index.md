---
title: JWT - Библиотека аутентификации производственного уровня
description: Библиотека CyberGo JWT производственного уровня для Go с поддержкой подписи HMAC/RSA/ECDSA, чёрным списком токенов, ограничением скорости, пользовательскими Claims и внедрением часов. Все методы безопасны для конкурентного использования.
---
