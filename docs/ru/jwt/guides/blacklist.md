...
description: "Руководство CyberGo JWT по чёрному списку токенов: настройка встроенного хранилища в памяти, пользовательский бэкенд BlacklistStore (Redis), механизм отзыва, автоматическая очистка и лучшие практики для производственной среды."
---
