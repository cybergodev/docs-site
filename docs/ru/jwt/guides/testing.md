---
title: Тестирование и внедрение часов - JWT
description: "Руководство CyberGo JWT по тестированию и внедрению часов: интерфейс ClockProvider, использование FixedClock, модульное тестирование истечения токенов, обновления и валидации пользовательских Claims."
---
