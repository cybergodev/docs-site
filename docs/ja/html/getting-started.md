---
title: クイックスタート - HTML
description: CyberGo HTML ライブラリのクイックスタートチュートリアル。5 分でインストール、基本的なコンテンツ抽出、4 種類の Config プリセット（デフォルト、テキストのみ、Markdown、高セキュリティ）、プレーンテキスト・Markdown・JSON の 3 種類の出力フォーマット、コンテキストタイムアウト制御、並列安全な使用パターンを習得し、HTML コンテンツ抽出ツールをすぐに使い始められます。
---
...
すべての関数に `WithContext` バージョンがあり、キャンセルとタイムアウトをサポートします：
...
- [コンテンツ抽出の実践](./guides/content-extraction) - 抽出フローと記事認識の深い理解
