---
title: "型定義 - HTML"
description: "CyberGo HTML のデータ型 API リファレンス。Result(カスタム JSON シリアライズ付き)、ImageInfo、LinkInfo、VideoInfo、AudioInfo、LinkResource、Statistics、BatchResult、NodeAttr など主要型のフィールドを説明します。"
---
