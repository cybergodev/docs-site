---
title: 基本サンプル - HTML
description: CyberGo HTML ライブラリの基本サンプル集。基本的なコンテンツ抽出、ファイルからの抽出、プレーンテキスト抽出、Markdown フォーマット出力、リンク抽出とグループ化、Processor インスタンスの再利用、タイムアウト制御付きコンテキスト抽出、並列バッチ処理、JSON シリアライズ出力など、よくある開発シーンの例をすべて直接コピーして実行できます。
---
