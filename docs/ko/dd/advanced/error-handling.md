...
description: "CyberGo DD 오류 처리 전체 가이드. 구조화된 오류 타입과 계층, 오류 코드 설계, 센티넬 오류 정의와 판단, errors.Is/As 래핑과 언래핑, 커스텀 오류 처리 전략, 오류 복구 및 오류 훅 콜백 설정으로 다양한 로그 오류를 정확하게 식별하고 처리합니다."
sidebar_position: 2
---
...
- [상수와 오류](../api-reference/dev-tools/constants) -- 전체 오류 코드 목록
