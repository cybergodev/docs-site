...
description: "CyberGo DD 로그 라이브러리 보안 기능 개요. 민감 데이터 자동 감지와 마스킹, 파일 경로 보안 검증과 보호, 비동기 감사 이벤트 기록과 체인 추적, HMAC 무결성 서명 변조 방지, 준수 설정 모범 사례로 데이터 필터링부터 감사 추적까지 전면적인 보안을 보장합니다."
sidebar_position: 1
---
