...
description: "CyberGo DD 자주 사용하는 API 치트시트. 로거 생성과 복제, 로그 레벨 제어, 구조화된 필드 생성, 파일 순환과 버퍼 설정, 민감 데이터 필터링 규칙, 훅 등록과 콜백 처리, 감사 로그 기록, 무결성 서명 검증 등 고빈도 작업을 다루어 빠르게 참조할 수 있습니다."
sidebar_position: 2
---
