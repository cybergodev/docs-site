---
sidebar_label: "개요"
title: "구조화 로그 - CyberGo DD | 고성능 Go 로그"
description: "CyberGo DD는 고성능 Go 구조화된 로그 라이브러리로, 스레드 안전 기록, 유연한 출력 대상, 파일 자동 순환, 민감 데이터 필터링, 비동기 감사 로그, HMAC 서명, 제로 할당 최적화로 안전하고 신뢰할 수 있는 로그 시스템 구축을 지원합니다."
---
