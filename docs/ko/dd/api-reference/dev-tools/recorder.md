...
description: "CyberGo DD 테스트 보조 LoggerRecorder API 문서. 단위 테스트용으로 로그 출력을 캡처하고 단언하며, 레벨별 필터링, 구조화된 필드 값 검증, 항목 수 통계, 순차적 단언을 지원해 로그 단위 테스트 작성 효율성과 가독성을 향상시킵니다."
sidebar_position: 2
---
...
- [Logger](../core/logger) -- Logger 전체 메서드
