...
description: "CyberGo DD 디버그 출력 함수 API 문서. Print 포맷팅 인쇄, JSON 구조화된 출력, Text 일반 텍스트 출력, Exit 치명적 종료 등 빠른 디버그 함수로 Logger 인스턴스 없이 패키지 수준 함수로 직접 호출해 개발 디버그 과정을 간소화합니다."
sidebar_position: 1
---
