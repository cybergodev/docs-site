...
description: "CyberGo DD 상수와 오류 타입 문서. LogLevel (Debug/Info/Warn/Error/Fatal), Format 출력 형식, SentinelErrors 센티넬 오류 정의로 로그 동작과 오류 처리를 정밀하게 제어하며 DD 설정 체계의 핵심 기초입니다."
sidebar_position: 3
---
