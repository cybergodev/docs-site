...
description: "CyberGo DD 민감 데이터 필터링 API 문서. SensitiveDataFilter 규칙, SecurityConfig 정책, 사전 설정 방안으로 비밀번호, API 키, Token, 휴대전화, 신분증 번호 등을 자동 감지하고 마스킹해 로그 유출 위험을 방지합니다."
sidebar_position: 2
---
...
- [설정](../core/config) -- SecurityConfig 설정
