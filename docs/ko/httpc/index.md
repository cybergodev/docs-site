...
description: CyberGo HTTPC는 Go 언어를 위한 안전한 고성능 HTTP 클라이언트 라이브러리로, 기본 보안 설계, TLS 1.2+ 강제 암호화, SSRF 방어, 스마트 재시도 메커니즘, 양파 모델 미들웨어 체인 및 객체 풀 재사용을 내장하여 마이크로서비스 아키텍처와 보안 민감 시나리오의 HTTP 통신 요구에 적합합니다.
---
...
| 목표 | 추천 |
|------|------|
| 5분 안에 시작하기 | [빠른 시작](./getting-started) |
| 30분 실전 연습 | [실전 튜토리얼](./guides/tutorial) |
| 특정 사용법 찾기 | [치트시트](./cheatsheet) |
| 보안 기능 이해하기 | [보안 개요](./security/) |
| API 시그니처 확인 | [API 참조](./api-reference/) |
