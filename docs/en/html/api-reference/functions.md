...
description: API reference for CyberGo HTML package-level functions including Extract, ExtractText, and context variants, using sync.Pool for efficient content extraction.
---
