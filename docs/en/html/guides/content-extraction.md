...
:::tip Note
`strings.Contains` in this example is from the standard library `strings` package. For a complete runnable example, see [Testing & Custom Extensions](./testing-custom).
:::
...
- [Processor Cache & Reuse](./processor-cache) - Performance optimization for high-frequency calls
- [API Reference: Functions](../api-reference/functions) - Complete function signatures
