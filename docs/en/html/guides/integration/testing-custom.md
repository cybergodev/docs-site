...
- [API Reference: Interfaces](../../api-reference/types/interfaces) - Scorer and ContentNode complete definitions
- [API Reference: Config](../../api-reference/core/config) - Scorer config field
