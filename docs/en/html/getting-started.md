...
description: "Quick start with CyberGo HTML in 5 minutes: installation, basic extraction, Config presets, output formats (text, Markdown, JSON), timeouts, and concurrency-safe patterns."
---
...
- [Content Extraction Guide](./guides/content-extraction) - Deep dive into extraction and article recognition
- [Output Formats](./guides/output-formats) - Choose the right output format for your use case
- [Processor Cache & Reuse](./guides/processor-cache) - Performance optimization for high-frequency calls
