...
description: "CyberGo HTML security overview: input size limit (default 50MB), DOM depth (500), path traversal prevention, panic recovery, timeouts, content sanitization, and audit with errors.Is/As."
---
