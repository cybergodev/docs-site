...
description: "CyberGo HTML error handling guide: five error categories, errors.Is sentinel matching, errors.As structured extraction, context cancellation, and batch partial-failure patterns."
---
