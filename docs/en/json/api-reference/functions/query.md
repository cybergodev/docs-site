...
description: "CyberGo JSON query and get: Get/GetString/GetInt/GetFloat/GetBool getters, GetTyped[T] generics, GetMultiple batch and SafeGet access with full JSONPath."
sidebar_position: 2
---
...
- [Parse and Validate Functions](./parse) - Parse, Valid, ValidateSchema and other parse/validate operations
