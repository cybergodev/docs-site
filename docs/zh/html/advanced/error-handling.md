---
title: 错误处理 - HTML
description: CyberGo HTML 库错误处理完整指南，包括五类错误分类（输入错误、配置错误、文件错误、处理错误、系统错误）、errors.Is 哨兵错误判断模式、errors.As 结构化错误信息提取详解、context 上下文取消处理和批量处理部分失败处理模式，帮助构建健壮的错误处理逻辑。
---
