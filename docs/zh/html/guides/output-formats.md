...
```json
{
  ...
  "links": [
    {"url": "https://go.dev", "text": "Go 官网", "title": "", "is_external": true, "is_no_follow": false, "position": 1}
  ],
...
- [API 参考：输出格式](../api-reference/output) - 完整 API 签名
- [链接提取与分组](../guides/link-extraction) - 提取页面资源链接
- [配置详解](../api-reference/config) - 所有配置选项
