---
title: "类型定义 - HTML"
description: "CyberGo HTML 数据类型 API 参考，涵盖 Result（含自定义 JSON 序列化）、ImageInfo、LinkInfo、VideoInfo、AudioInfo、LinkResource、Statistics、BatchResult、NodeAttr 等核心类型的字段说明。"
---
