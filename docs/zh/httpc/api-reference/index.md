---
title: API 参考 - HTTPC
description: HTTPC API 参考文档的索引总页面，按功能模块分类组织全部公开包级函数、Client 接口方法、二十六个请求选项函数、内置中间件系统、错误类型、配置结构体和常量定义的详细文档链接，帮助 Go 开发者快速定位所需接口定义与完整使用说明。
---

# API 参考

HTTPC 提供 26 个请求选项函数、5 个配置预设、8 个内置中间件和完整的下载支持。
...
| 模块 | 说明 |
|------|------|
| [请求选项](./options) | 26 个 WithXxx 请求选项函数（请求头、请求体、认证、Cookie、回调等） |
