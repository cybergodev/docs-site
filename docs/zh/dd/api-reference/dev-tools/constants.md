...
| 常量 | 值 | 说明 |
|------|----|------|
| `HashAlgorithmSHA256` | 0 | SHA-256 算法（用于[完整性签名](../security-audit/integrity)） |
...
- [包函数](../core/functions) -- 错误处理函数
- [安全过滤](../security-audit/security) -- 路径安全验证
- [钩子系统](../security-audit/hooks) -- OnError 钩子
