...
description: "CyberGo JSON 自定义编码器指南：详解 CustomEncoder 接口和 TypeEncoder 类型编码器的定义、配置方式和实现示例，支持为自定义 Go 结构体和非标准类型注册专用的 JSON 序列化与反序列化逻辑，灵活控制编解码行为。"
---
...
- [接口定义](./interfaces) - CustomEncoder 和 TypeEncoder 接口
- [配置选项](./config) - Config 编码相关字段
