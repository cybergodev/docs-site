...
description: "CyberGo JSON Processor 批量操作方法完整参考：ProcessBatch 批量处理多个操作、BatchOperation 操作定义（get/set/delete 类型）、BatchResult 结果类型、错误处理策略和 ContinueOnError 配置，支持事务性批量操作和性能优化。"
---
